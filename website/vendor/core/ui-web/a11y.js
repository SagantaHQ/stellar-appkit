 ...
 */
export function trapFocus(stableRoot, getContainer) {
    ...
    function onKeydown(e) {
        ...
        const active = stableRoot.activeElement;
    ...
    stableRoot.addEventListener('keydown', onKeydown);
    return () => {
        stableRoot.removeEventListener('keydown', onKeydown);
